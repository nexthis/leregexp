...
<template>
    <div class="relative min-h-11">
        <input v-model="model" class="absolute block text-transparent bg-transparent caret-white left-0 right-0 p-2.5 w-full h-full border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="/regex/" >
